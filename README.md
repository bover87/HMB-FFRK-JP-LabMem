...
- You MUST use LabMem 8.3.2 or later. Otherwise, the bot will often detect false "crashes" mid-battle and restart constantly. For versions 8.3.2 through 10.0.2, Hyper-V must be running or the bot will still detect these false "crashes" during battle. Starting with version 10.1, crash detection is fully fixed and will work correctly on all emulator versions regardless of Hyper-V status or your Android version.
